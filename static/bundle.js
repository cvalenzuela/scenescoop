...
},{"global/document":3,"global/window":4,"safe-json-parse/tuple":7,"tsml":9,"videojs-vtt.js":11,"xhr":15}],11:[function(require,module,exports){
/**
...
},{"./vtt.js":12,"./vttcue.js":13,"./vttregion.js":14,"global/window":4}],12:[function(require,module,exports){
/**
 * Copyright 2013 vtt.js Contributors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"global/window":4,"is-function":5,"parse-headers":6,"xtend":16}],16:[function(require,module,exports){
...
var sceneSearch = false;
var currentSceneDescription = '';
var currentInputName = '';
var videoUploadRoute = '/upload';
var makeVideoRoute = '/make';
var outputVideosPath = 'videos/outputs';
...
window.addEventListener("load", function () {
  ...
  var loadingTextInput = document.getElementById("loadingTextInput");
  var loadingTextOutput = document.getElementById("loadingTextOutput");
  var sceneSearchBtn = document.getElementById("sceneSearch");
  ...
  var onSelectFile = function onSelectFile() {
    ...
    inputText.innerText = '';
    (0, _video.changeSource)(_video.input, url);
  };
  ...
  form.addEventListener("submit", function (event) {
    ...
    sceneSearch = false;
    event.preventDefault();
    (0, _manageForm.sendData)(form, { name: currentInputName }, videoUploadRoute, function (response) {
  ...
  sceneSearchBtn.addEventListener('click', function () {
    if (true) {
      ...
      var data = {
        ...
        duration: _video.input.duration(),
        movie: movies.value
      };
      (0, _manageForm.sendData)(form, data, makeVideoRoute, function (response) {
        response = JSON.parse(response);
        loadingTextOutput.style.display = 'none';
        if (response.status == 200) {
          var description = response.movie.scene_closest_meaning;
          outputText.innerText = description.charAt(0).toUpperCase() + description.slice(1);
          updateSceneSearchBtn('ACTIVATE');
          sceneSearch = true;
          (0, _video.changeSource)(_video.output, '' + outputVideosPath + response.movie.name);
        }
      });
    }
  });
  ...
  // Utils
  var updateSceneSearchBtn = function updateSceneSearchBtn(state) {
...
},{"./manageForm":18,"./video":19}],18:[function(require,module,exports){
"use strict";
...
var sendData = function sendData(form, data, route, callback) {
...
exports.changeSource = exports.output = exports.input = undefined;
...
// Input video
var input = (0, _video2.default)("inputVideo", {
  controls: true,
  autoplay: true,
  loop: true,
  preload: 'auto',
...
var changeSource = function changeSource(elt, source) {
  var src = {
    src: source,
    type: 'video/mp4'
  };
...
var output = (0, _video2.default)("outputVideo", {
  controls: true,
  autoplay: true,
  loop: true,
  preload: 'auto',
